...
public class SkillProperties implements ISkillProperties {
    ...
    public SkillProperties(RegistryObject<Specialization> pParentSpecialization, IItemProvider pItemLike, IntValue pRow, IntValue pColumn, IntValue pMaxLevel, IntValue pCostPerLevel, DoubleValue pBonusPerLevel, ConfigValue<String> pPrerequisites) {
    ...
    public static SkillProperties of(RegistryObject<Specialization> pParentSpecialization, IItemProvider pItemLike, IntValue pRow, IntValue pColumn, IntValue pMaxLevel, IntValue pCostPerLevel, DoubleValue pBonusPerLevel, ConfigValue<String> pPrerequisites) {
