...
public class NetworkHandler {
    ...
    public static void init() {
        SimpleChannel instance = ChannelBuilder.named(new ResourceLocation(BetterLeveling.MOD_ID, "messages")).networkProtocolVersion(1).clientAcceptedVersions((pStatus, pVersion) -> true).serverAcceptedVersions((pStatus, pVersion) -> true).simpleChannel();
        INSTANCE = instance;

        instance.messageBuilder(UnlockSpecializationC2SPacket.class, id(), NetworkDirection.PLAY_TO_SERVER)
                ...
                .add();
        instance.messageBuilder(RequestSpecializationsScreenC2SPacket.class, id(), NetworkDirection.PLAY_TO_SERVER)
                ...
                .add();
        instance.messageBuilder(IncreaseSkillC2SPacket.class, id(), NetworkDirection.PLAY_TO_SERVER)
                .decoder(IncreaseSkillC2SPacket::new)
                .encoder(IncreaseSkillC2SPacket::encode)
                .consumerMainThread(IncreaseSkillC2SPacket::handle)
                .add();
        instance.messageBuilder(DecreaseSkillC2SPacket.class, id(), NetworkDirection.PLAY_TO_SERVER)
                .decoder(DecreaseSkillC2SPacket::new)
                .encoder(DecreaseSkillC2SPacket::encode)
                .consumerMainThread(DecreaseSkillC2SPacket::handle)
                .add();
        instance.messageBuilder(RequestSkillScreenUpdateC2SPacket.class, id(), NetworkDirection.PLAY_TO_SERVER)
        ...
        instance.messageBuilder(SyncDataS2CPacket.class, id(), NetworkDirection.PLAY_TO_CLIENT)
                ...
                .add();
        instance.messageBuilder(RefreshSpecializationScreenS2CPacket.class, id(), NetworkDirection.PLAY_TO_CLIENT)
                ...
                .add();
        instance.messageBuilder(RefreshSkillScreenS2CPacket.class, id(), NetworkDirection.PLAY_TO_CLIENT)
