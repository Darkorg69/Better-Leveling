...
public class ModLanguageProvider extends LanguageProvider {
    ...
    protected void addTranslations() {
        ...
        add(ModItems.RAW_IRON.get(), "Raw Iron");
        add(ModItems.RAW_GOLD.get(), "Raw Gold");
        add(ModItems.RAW_DEBRIS.get(), "Raw Debris");
        add(ModBlocks.RAW_IRON_BLOCK.get(), "Raw Iron Block");
        add(ModBlocks.RAW_GOLD_BLOCK.get(), "Raw Gold Block");
    ...
    private void add(TranslationTextComponent pTranslatableContents, String pTranslation) {
