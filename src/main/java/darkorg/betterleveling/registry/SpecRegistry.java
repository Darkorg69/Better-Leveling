...
public class SpecRegistry {
    ...
    public static final ISpecialization COMBAT = new Specialization(BetterLeveling.MOD_ID, "combat", STONE_SWORD);
    public static final ISpecialization CRAFTING = new Specialization(BetterLeveling.MOD_ID, "crafting", CRAFTING_TABLE);
    public static final ISpecialization MINING = new Specialization(BetterLeveling.MOD_ID, "mining", STONE_PICKAXE);
