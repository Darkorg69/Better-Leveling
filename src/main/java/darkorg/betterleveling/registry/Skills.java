...
public class Skills {
    private static final DeferredRegister<Skill> SKILLS = DeferredRegister.create(Skill.class, BetterLeveling.MOD_ID);
    ...
    private static final Supplier<IForgeRegistry<Skill>> REGISTRY = Skills.SKILLS.makeRegistry("skills", RegistryBuilder::new);
