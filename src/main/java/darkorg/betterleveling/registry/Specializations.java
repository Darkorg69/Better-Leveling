...
public class Specializations {
    private static final DeferredRegister<Specialization> SPECIALIZATIONS = DeferredRegister.create(Specialization.class, BetterLeveling.MOD_ID);
    ...
    private static final Supplier<IForgeRegistry<Specialization>> REGISTRY = SPECIALIZATIONS.makeRegistry("specializations", RegistryBuilder::new);
