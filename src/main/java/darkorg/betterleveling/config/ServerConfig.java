...
public class ServerConfig {
    ...
    public static final ForgeConfigSpec.ConfigValue<Integer> SECONDARY_SPEC_COST;
    public static final ForgeConfigSpec.ConfigValue<Double> COMBAT_XP_BONUS;
    public static final ForgeConfigSpec.ConfigValue<Double> CRAFTING_XP_BONUS;
    public static final ForgeConfigSpec.ConfigValue<Double> MINING_XP_BONUS;
    ...
    static {
        ...
        SECONDARY_SPEC_COST = BUILDER.comment("Define how much levels the player needs to unlock a secondary specialization").defineInRange("Secondary Specialization Level Cost", 30, 0, Integer.MAX_VALUE);

        COMBAT_XP_BONUS = BUILDER.comment("Define the amount of bonus XP on kill, based on the original dropped XP.").defineInRange("Combat XP Bonus Bound", 1.0D, 0.0D, Double.MAX_VALUE);
        CRAFTING_XP_BONUS = BUILDER.comment("Define the multiplier for the amount of bonus XP when crafting").defineInRange("Crafting XP Bonus", 1.0D, 0.0D, Double.MAX_VALUE);
        MINING_XP_BONUS = BUILDER.comment("Define the amount of bonus XP dropped when mining, based on the original dropped XP.").defineInRange("Mining XP Bonus Bound", 1.0D, 0.0D, Double.MAX_VALUE);

        BUILDER.pop();

        BUILDER.push("Skills");
        XP_REFUND_FACTOR = BUILDER.comment("Define the amount of XP refunded when decreasing skill level").defineInRange("XP Refund Factor", 0.5D, 0.0D, 1.0D);
        ...
        ARROW_SPEED_BONUS_PER_LEVEL = BUILDER.defineInRange("Bonus per level", 0.03D, 0.0D, Double.MAX_VALUE);
        ...
        GREEN_THUMB_BONUS_PER_LEVEL = BUILDER.defineInRange("Bonus per level", 0.015D, 0.0D, Double.MAX_VALUE);
        ...
        PROSPECTING_BONUS_PER_LEVEL = BUILDER.defineInRange("Bonus per level", 0.075D, 0.0D, Double.MAX_VALUE);
        ...
        TREASURE_HUNTING_BONUS_PER_LEVEL = BUILDER.defineInRange("Bonus per level", 0.0125D, 0.0D, Double.MAX_VALUE);
